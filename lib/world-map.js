 ...
 * @param {Object} params.regionStyle Set the styles for the map's regions.
 * @param {Object} params.markerStyle Set the styles for the map's markers.
...
jvm.WorldMap.prototype = {
   ...
   * @param {Object|Array} markers Markers to add to the map. In case of array was provided codes of markers will be set as string of representations of array indexes.
   * @param {Array} seriesData Values to add to the data series.
   */
