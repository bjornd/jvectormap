...
jvm.WorldMap.prototype = {
  ...
  applyTransform: function() {
    var maxTransX, maxTransY, minTransX, minTransY,
        viewportChangeEvent = jvm.$.Event('viewportChange.jvectormap');
    ...
    this.container.trigger(viewportChangeEvent, [this.scale, this.transX, this.transY]);
  },
  ...
  setScale: function(scale, anchorX, anchorY, isCentered) {
    var zoomStep,
        zoomEvent = jvm.$.Event('zoom.jvectormap');
    ...
    this.container.trigger(zoomEvent, [scale/this.baseScale]);
  },
