...
jvm.WorldMap = function(params) {
  ...
  $(params.container).delegate('.jvectormap-region, .jvectormap-marker', 'click', function(e){
    ...
    $(params.container).trigger(clickEvent, [code]);
    if ((type === 'region' && params.regionsSelectable) || (type === 'marker' && params.markersSelectable)) {
      if (!clickEvent.isDefaultPrevented()) {
        element.setSelected(!element.isSelected);
        $(params.container).trigger(
